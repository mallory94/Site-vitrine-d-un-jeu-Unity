      ...
      <div class="book">
         <div id="pages" class="pages">
            ...
            <div class="page"style="z-index:10;">
               ...
               <br> 
               <p>Dans une petite ville d'Amérique du Nord, vit Mme.Enokson, une scientifique expérimentée venant de l'institut Rafenwer et connue pour ses idées farfelues. Depuis son plus jeune âge, cette dernière aime tenter l’impossible et l’inaccessible. Quelques années plus tard, elle décide alors d'essayer de créer des trous de vers artificiels. Pour l’aider dans sa quête, elle embauche un stagiaire, en l'occurrence vous, afin de réaliser ces expériences. </p>
            </div>
            ...
            <div class="page"style="z-index:8;">
               ...
               <br>
               <p>
               Après de longues et rudes semaines de recherche, vous finissez par enfin créer le tout premier trou de vers stable. Tout semble se dérouler comme prévu, lorsque tout à coup, le portail laisse échapper des créatures venant d’une toute autre dimension.               </p>
            </div>
