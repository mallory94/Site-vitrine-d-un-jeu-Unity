         ...
         <div class="monstres" >
            ...
            <div class="wrapper">
               ...
               <div style="
                  ...
                  <div>
                     <div class="cartes">
                        <h1 style=" padding: 23px 50px 24px 135px;">CARTES </h1>
                        <div>
                           <img src="./vue/images/carousel/laboEbauche.png" style="padding: 23px 50px 24px 220px; opacity:99%;"/>
                        </div>
                     </div>
                  </div>
                  <!-- end wrapper -->
